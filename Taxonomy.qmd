...
When categorising data gaps for this project, we rely on a modified version of a taxonomy developed by [Climate Change AI](https://www.climatechange.ai/dev/datagaps/info#taxonomy-of-data-gaps). Note that any particular gap may span multiple categories, and the boundaries between them are not always clear.
